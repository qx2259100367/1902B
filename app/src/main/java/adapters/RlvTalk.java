...
public class RlvTalk extends RecyclerView.Adapter {

    private ArrayList<TalkBean.StoriesBean> list;

    public RlvTalk(ArrayList<TalkBean.StoriesBean> list) {
        this.list = list;
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        ...
        Glide.with(holder.itemView).load(list.get(position).getImages().get(0)).into(holder1.mTalkimg);
